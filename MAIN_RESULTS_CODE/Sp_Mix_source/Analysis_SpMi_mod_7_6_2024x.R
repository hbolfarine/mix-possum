...
## read sources
source("Dropbox/DSS_MIX/DSS_MIX_06_2024/source/Sp_Mix_source/Random_SpMix.R")
...
estGibbs <- MultVar_NormMixt_Gibbs_IndPriorNormalgamma(y, S_0, mu_0, sigma_0, eta_0, e0, c0, C0_0, 
                                    g0, G0, b0, B0, nu, B_0, M, burnin, c_proposal, priorOnE0 = FALSE, lambda = FALSE, R)
...
mclust = Mclust(y)
mclust_class = mclust$classification
table(z, mclust_class)
adjustedRandIndex(z, mclust_class)
classError(mclust_class, z)$errorRate
