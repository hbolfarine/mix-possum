...
$$\boldsymbol{\hat{\gamma}}^k := \arg\min_{\boldsymbol{\gamma}^k \in \boldsymbol{\Gamma}^k}\mathbb{E}_{\boldsymbol{\tilde{y}}_n \mid \boldsymbol{y}} \left[ L(\widetilde{f}, g_{\boldsymbol{\gamma}}) \right]$$.
